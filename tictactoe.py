#!/usr/bin/python3
#TicTacToe
#By Pruthvi Nag pruthvi.surapaneni@gmail.com
...
def main():
  global FPSCLOCK, DISPLAYSURF, BASICFONT, WINNER, AGAIN_SURF, AGAIN_RECT, PSURF, PRECT
	...
	BASICFONT = pygame.font.Font("28 Days Later.ttf", BASICFONTSIZE)
	...
	while True:
		...
		if WINNER == None:
			...
			pygame.draw.lines(DISPLAYSURF, ORANGE, False, coords, 2)
...
def drawX(boxx, boxy):
	...
	pygame.draw.line(DISPLAYSURF, BLUE, startPoint1, endPoint1, 1)
	pygame.draw.line(DISPLAYSURF, BLUE, startPoint2, endPoint2, 1)
	return 0

def drawO(boxx, boxy):
	ltx, lty = leftTopCoordsOfBox(boxx, boxy)
	center = (int(ltx + (BOXSIZE / 2)), int(lty + (BOXSIZE / 2)))
	pygame.draw.circle(DISPLAYSURF, BLUE, center, int((BOXSIZE / 2) - 5), 1)
	return 0
